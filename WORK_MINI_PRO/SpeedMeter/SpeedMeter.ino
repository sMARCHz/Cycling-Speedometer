...
void setup()
 {
   ...
   attachInterrupt(0, magnet_detect, FALLING); //secound pin of arduino used as interrupt and magnet_detect will be called for each interrupt
...
void loop()
{
 ...
 if(millis()-dtime>1500) //no magnet found for 1500ms
 {
  ...
  Cycle_BT.write(v);  // Chang to display you want...
  dtime=millis();
 }
